...
namespace svd
{
    ...
    void Mat3::set(const float mm00, const float mm01, const float mm02,
                   const float mm10, const float mm11, const float mm12,
                   const float mm20, const float mm21, const float mm22)
    {
        this->m00 = mm00;
        this->m01 = mm01;
        this->m02 = mm02;
    ...
    void Vec3::set(const float mx, const float my, const float mz)
    {
        this->x = mx;
        this->y = my;
        this->z = mz;
